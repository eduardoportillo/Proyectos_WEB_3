...
class Producto(models.Model):
    ...
    id_empresa = models.ForeignKey(Empresa, null=False, on_delete=models.CASCADE, related_name='empresa_producto')
    id_categoria = models.ForeignKey(Categoria, null=False, on_delete=models.CASCADE, related_name='categoria_producto')
